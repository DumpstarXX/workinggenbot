...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/disney.txt', 'utf8', function(err, data) {
            ...
            .addField('Here Is Your Disney Acc! ',`\n**${account}**`)
            .setColor("#363940")
            .setTimestamp();
...
module.exports.help = {
    name: `disney`,
    description: `Sends you a Disney acc `
};