...
module.exports.run = async (client, msg, args, config) => {
    if(cooldown.has(msg.author.id)) {
        ...
        fs.readFile('./accounts/crunchyroll.txt', 'utf8', function(err, data) {
            ...
            .addField('Here Is Your Cunchyroll Acc!',`\n**${account}**`)
            .setColor("#363940")
            .setTimestamp();
...
var xd = new Discord.MessageEmbed()
        .setColor("#ff0000")
        .setTitle("CHECK YOUR DMs i have a send Crunchyroll acc")
      
        .setImage("https://cdn.discordapp.com/attachments/848298340491722815/848323916074319872/gifgit.gif")
        .setTimestamp()
        .setDescription("I've sent you a Crunchyroll acc")
...
module.exports.help = {
    name: `crunchyroll`,
    description: `Sends you a Crunchyroll acc`
    };